...
* `data/precip.RData`: The precipitation data for the eight subregions, which contains `R` objects:
...
* `data/era5_geoinfo.RData`: Shape files for the eight subregions, which contains `R` objects:
    + `shape1`: shape file of the US river-basins
    + `shape3`: shape file of Danube river-basin
* `data/transformed_coordinates.RData`: Transformed coordinates for the eight subregions, which transformed the latitude/longitude coordinate to the Eculidean coordinate and contains `R` objects:  
